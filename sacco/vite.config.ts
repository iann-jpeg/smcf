...
export default defineConfig(({ mode }) => ({
  // SACCO is deployed under /sacco/, so production assets must also resolve
  // under /sacco/ (for example /sacco/assets/*).
  // In dev (mode === 'development') the Vite server runs at the root.

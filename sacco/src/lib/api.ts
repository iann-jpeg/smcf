 ...
 * Reads VITE_SACCO_API_URL at build time; attaches JWT from localStorage on every request.
 * Using a distinct name (not VITE_API_URL) avoids collision with the main smcf.app env var.
 */

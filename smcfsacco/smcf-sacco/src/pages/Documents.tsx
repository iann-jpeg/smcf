...
type Loan = {
  id: string;
  loan_number?: string;
  members?: { name?: string; member_id?: string };
...
type Guarantor = {
  id: string;
  members?: { name?: string; savings?: number; member_id?: string };
  loans?: { loan_number?: string; status?: string };
...
const ADMIN_POLICY_TEMPLATES: AdminPolicyTemplate[] = [
  {
    id: "smcf-constitution",
    title: "Investment Group Constitution",
    subtitle: "Official SMCF Group Constitution",
    fileName: "SMCF_Investment_Group_Constitution.pdf",
    lines: [
      "# SMART MOVES CASH FLOW (SMCF)",
      "",
      "## INVESTMENT GROUP CONSTITUTION",
      "",
      "---",
      "",
      "## 1. NAME OF THE GROUP",
      "",
      "The name of the group shall be **SMART MONEY CASH FLOW (SMCF)**, hereinafter referred to as “the Group”.",
      "",
      "---",
      "",
      "## 2. REGISTERED OFFICE / ADDRESS",
      "",
      "The registered office of the Group shall be located at:",
      "[Insert Chairperson or Treasurer Physical Address]",
      "",
      "The Group shall primarily operate through a **digital platform** for communication, contributions, and financial management.",
      "",
      "---",
      "",
      "## 3. OBJECTIVES OF THE GROUP",
      "",
      "The objectives of SMCF are:",
      "",
      "1. To promote a culture of saving among members",
      "2. To provide accessible and affordable loans to members",
      "3. To support financial growth and stability of members",
      "4. To create a structured and transparent financial system",
      "5. To empower SMEs, students, and entrepreneurs financially",
      "6. To invest collectively for mutual benefit",
      "",
      "---",
      "",
      "## 4. MEMBERSHIP",
      ...
      "",
      "* Are above 18 years",
      "* Agree to abide by this constitution",
      ...
      "### 4.2 Admission",
      "",
      "A person shall become a member after:",
      "",
      ...
      "",
      "Each member shall pay a **non-refundable registration fee of KES 100**.",
      "",
      "---",
      "",
      ...
      "",
      "* Fails to contribute consistently",
      "* Defaults on loans",
      ...
      "## 5. CONTRIBUTIONS",
      "",
      "### 5.1 Minimum Contribution",
      "",
      "Each member shall contribute a **minimum of KES 500 per month**.",
      "",
      "---",
      "",
      "### 5.2 Flexible Contributions",
      "",
      "Members may contribute more than the minimum amount at any time.",
      "",
      "---",
      "",
      "### 5.3 Contribution Mode",
      "",
      "Contributions shall be made via:",
      "",
      "* M-PESA",
      "* Bank transfer",
      "* Any approved digital platform",
      "",
      "---",
      "",
      "### 5.4 Contribution Records",
      "",
      "All contributions shall be recorded digitally and made visible to members.",
      "",
      "---",
      "",
      "## 6. LOAN POLICY",
      ...
      "",
      "A member qualifies for a loan if:",
      "",
      "* Has saved for at least **3 months**",
      "* Has demonstrated contribution consistency",
      "* Meets the Group’s activity and trust requirements",
      "",
      "---",
      "",
      "### 6.2 Loan Limits",
      "",
      "Loan amounts shall be based on:",
      "",
      "* Member savings",
      "* Group capital availability",
      "* Internal loan rules",
      "",
      "---",
      "",
      "### 6.3 Loan Approval",
      "",
      "Loans shall be approved by:",
      "",
      "* Loan Committee",
      "  OR",
      "* Authorized system approval process",
      "",
      "---",
      "",
      "### 6.4 Repayment",
      "",
      "Members must repay loans within agreed timelines.",
      "",
      "---",
      "",
      "### 6.5 Default",
      ...
      "",
      "* Penalties may apply",
      "* Guarantors may be engaged",
      "* Member privileges may be suspended",
      "",
      "---",
      "",
      "## 7. MANAGEMENT STRUCTURE",
      "",
      "The Group shall have the following officials:",
      "",
      "### 7.1 Chairperson",
      "",
      "* Provides leadership",
      ...
      "### 7.5 Term of Office",
      "",
      "Officials shall serve for a period of **1 year**, renewable.",
      "",
      "---",
      "",
      "## 8. MEETINGS",
      ...
      "",
      "The Group shall hold regular meetings:",
      "",
      ...
      "### 8.3 Quorum",
      "",
      "A meeting shall be valid if at least **50% of members** are present.",
      "",
      "---",
      "",
      "### 8.4 Decision Making",
      ...
      "### 9.1 Bank Account",
      "",
      "The Group shall operate a bank account in its name.",
      "",
      "---",
      "",
      "### 9.2 Signatories",
      "",
      "The account shall have at least **two or three signatories**, including:",
      "",
      "* Chairperson",
      "* Treasurer",
      "* Secretary",
      ...
      "### 9.4 Audit",
      "",
      "The Group may conduct periodic internal or external audits.",
      "",
      "---",
      "",
      "## 10. DIGITAL OPERATIONS",
      "",
      "SMCF shall operate through a digital system that:",
      "",
      ...
      "---",
      "",
      "## 11. DISCIPLINE AND PENALTIES",
      "",
      "Members may face penalties for:",
      "",
      "* Missing contributions",
      "* Late loan repayment",
      "* Misconduct",
      "",
      "Penalties shall be determined by the Group.",
      "",
      "---",
      "",
      "## 12. AMENDMENTS",
      ...
      "## 13. DISSOLUTION",
      "",
      "The Group may be dissolved if:",
      "",
      "* Members agree unanimously",
      "* Assets and liabilities are settled",
      "",
      "Remaining funds shall be shared among members proportionally.",
      "",
      "---",
      "",
      "## 14. ADOPTION",
      "",
      "This constitution was adopted on this date:",
      "",
      ...
      "## 15. SIGNATORIES",
      "",
      "We, the undersigned officials, adopt this constitution:",
      "",
      "---",
      "",
      "Chairperson Name: __________________________",
      ...
      "---",
      "",
      "Treasurer Name: __________________________",
      "Signature: __________________________",
      "Date: __________________________",
      "",
      "---",
      "",
      "## 16. MEMBER CONFIRMATION",
      "",
      "We, the members of SMART MONEY CASH FLOW (SMCF), agree to abide by this constitution.",
      "",
      "(Member signatures attached separately)",
      "",
      "---",
      "",
      "**END OF DOCUMENT**",
  ...
  },
  {
    ...
    lines: [
      ...
      "1. PURPOSE",
      "",
      "This policy defines the structure, contribution, management, and benefits of share capital within SMART MOVES CASH FLOW (SMCF).",
      "",
      "---",
      "",
      "2. DEFINITION",
      "",
      "Share capital refers to the amount invested by members as ownership in SMCF.",
      "",
      "It represents a member’s stake in the organization and is used to support long-term investments and growth.",
      "",
      "---",
      "",
      "3. MINIMUM SHARE CAPITAL",
      "",
      "Each member shall be required to acquire a minimum share capital of:",
      "",
      "KES 100",
      "",
      "---",
      ...
      "4. SHARE VALUE",
      "",
      "Each share shall have a value of:",
      "",
      "KES 100 per share",
      "",
      "---",
      ...
      "",
      "Members may contribute share capital:",
      "",
      "* As a lump sum",
      "  OR",
      "* In installments (recommended)",
      "",
      "---",
      "",
      "Installment Plan:",
      "",
      "Minimum monthly share contribution: KES 100",
      "",
      "Until the required minimum is reached.",
      "",
      "---",
      "",
      "6. NATURE OF SHARE CAPITAL",
      "",
      "* Share capital is **non-withdrawable**",
      "* It remains invested in SMCF",
      "* It is only refundable upon:",
      "",
      "  * Exit from SMCF",
      "  * According to exit policy",
      "",
      "---",
      "",
      "7. BENEFITS OF SHARE CAPITAL",
      "",
      "Members who hold shares are entitled to:",
      "",
      ...
      "* Proportionally to shares owned",
      "",
      "---",
      "",
      "9. SHARE TRANSFER",
      ...
      "Upon exit:",
      "",
      "* Share capital shall be refunded",
      "* Subject to:",
      "",
      "  * Notice period",
      "  * Financial position of SMCF",
      "",
      "---",
      "",
      "11. RECORD KEEPING",
      ...
      "12. COMPLIANCE",
      "",
      "All members must comply with this policy to maintain active status in SMCF.",
      "",
      "---",
      "",
      "13. AMENDMENTS",
...
export default function Documents() {
  const { data: loans = [] } = useLoans() as { data?: Loan[] };
  const { data: guarantors = [] } = useGuarantors() as { data?: Guarantor[] };
  ...
  const activeLoans = loans.filter((l) => ["repaying", "disbursed", "approved"].includes(l.status ?? ""));

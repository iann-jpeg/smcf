...
import "./LoanRepaymentDialog.css";
...
export function LoanRepaymentDialog({ open, onClose, loan, memberPhone, memberId }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v) { stopPolling(); onClose(); } }}>
      <DialogContent className="sm:max-w-md">
        ...
        {/* ── Step 2: Processing (STK sent, polling) ────────────────────── */}
        {step === "processing" && (
          <div className="flex flex-col items-center text-center py-4 gap-5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground text-sm max-w-xs">
                An M-Pesa STK push has been sent to <span className="font-semibold text-foreground">{phone}</span>. Enter your PIN to confirm payment of{" "}
          ...
          <div className="flex flex-col items-center text-center py-4 gap-5">
            ...
            <div className="space-y-1">
              <h3 className="font-heading font-bold text-lg text-green-700 dark:text-green-400">
                {loanCompleted ? "Loan Fully Repaid! 🎉" : "Payment Confirmed!"}
              </h3>
              <p className="text-muted-foreground text-sm max-w-xs">
                {loanCompleted
                  ? `Congratulations! Your loan ${loan.loan_number} has been fully cleared.`
                  : `Your repayment of KES ${amountNum.toLocaleString()} for loan ${loan.loan_number} has been confirmed.`}
              </p>
            </div>
        ...
        {step === "failed" && (
          <div className="flex flex-col items-center text-center py-4 gap-5">
            ...
            <div className="flex gap-2 w-full">
              ...
              <Button className="flex-1 gap-2" onClick={() => { setStep("input"); setFailReason(null); }}>
